...
[ operators_h, operators_d ] = prepareOperators( params, gpu );

%Prepare output fifles
...
fields_d.psi = operators_d.n_init+params.n0;
...
if params.dispOutput
    if params.is3D
        ...
        % figure(2)
        % imagesc(fields_d.psi(:,:,21));colorbar
        % figure(3)
        % imagesc(fields_d.psi(:,:,42));colorbar
    else
